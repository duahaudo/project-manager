...
const SECTIONS: { title: string; method: string; path: string; body?: string; notes?: string }[] = [
  ...
  { title: "Create ticket(s)", method: "POST", path: "/api/tickets", body: `{"projectKey":"ABT","title":"Login UI","type":"story","priority":"high","status":"To Do","phase":"P1","milestone":"M1","sprint":"Sprint 1","parentId":"<epic-ticket-id>","storyPoints":3,"labels":["auth"]}\n\n// bulk:\n{"tickets":[{...},{...}]}` },
...
const FIELDS = [
  ...
  ["parentId", "string | null — parent ticket id (use epic ticket id to link to an epic)"],
